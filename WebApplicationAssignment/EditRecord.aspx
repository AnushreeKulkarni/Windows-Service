...
<head runat="server">
    <title></title>
    <script src="js/JavaScriptEdit.js"></script>
</head>
<body>
    <form id="form1" runat="server" >
        <div style="height: 436px; background-color:beige">
            ...
            &nbsp;
            <asp:Button ID="btnEdit" runat="server" OnClick="btnEdit_Click" OnClientClick="return validateForm();" style="margin-left: 26px" Text="Edit" BackColor="#FF9999" BorderStyle="Groove" BorderWidth="5px" Height="38px" Width="98px" />
            <br />
            <br />
...
&nbsp; <asp:DropDownList ID="ddlAddresses1" runat="server" Width="162px" Height="22px" Visible="False" >
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblAddress3" runat="server" Text="Address One:" Font-Bold="True" Font-Names="Calibri" Visible="False"></asp:Label>
...
&nbsp;<asp:DropDownList ID="ddlAddresses2" runat="server" Width="162px" Height="22px" Visible="False" >
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lblAddress4" runat="server" Text="Address Two:" Font-Bold="True" Font-Names="Calibri" Visible="False"></asp:Label>
&nbsp; <asp:DropDownList ID="ddlAddresses4" runat="server" Width="162px" Height="22px" Visible="False" >
            </asp:DropDownList>
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnSave" runat="server" BackColor="#FF9999" BorderStyle="Groove" BorderWidth="5px" Height="38px" OnClick="btnSave_Click" OnClientClick="return validateForm();" style="margin-left: 17px; margin-top: 37px" Text="Update" Width="120px" Visible="False" />
            &nbsp;&nbsp;&nbsp;&nbsp;
